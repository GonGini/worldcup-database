...
echo "$($PSQL "SELECT name FROM games INNER JOIN teams ON games.opponent_id = teams.team_id OR games.winner_id = teams.team_id WHERE year = 2014 AND round = 'Eighth-Final' ORDER BY name")"
